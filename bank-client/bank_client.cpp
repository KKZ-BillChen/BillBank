...
void BankClient::print_Bank_introduction() {
	...
	std::cout << "		Nightshade - Nonpareil(N) 龙葵-极品:  " << endl;
	...
	//std::cout << "	Geranium - Gorgeous (G) 天竺葵-华丽：" << endl;
	...
	std::cout << "		Hollyhock - High-ranking(H) 蜀葵-高阶:  " << endl;
	...
	std::cout << "		Okra - Ordinary (O) 秋葵-普通:  " << endl;
